...
fun CardSamples() {
    ...
    Card(
        ...
        border = BorderStroke(0.5.dp, color = Color.Green), onClick = {
            Toast.makeText(context, "点击了卡片布局", Toast.LENGTH_SHORT).show()
        }
    ) {
        Text(
            text = "这个是卡片布局", modifier = Modifier
                .fillMaxWidth()
